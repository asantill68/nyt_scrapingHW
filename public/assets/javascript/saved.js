...
$(document).ready(function(){
    //  Getting a reference to the article container div will be rendering all articles inside of
    ...
    //  initPage kicks everything off when the pae is loaded
    initPage();
    ...
    function renderEmpty(){
        //  This function renders some HTML to the page explaining we do not have any articles to view
    ...
    function renderNotesList(data){
        ...
        if (!data.notes.length){
            ...
            for(var i=0; i<data.notes.length; i++){
                ...
                //  Store the note id on the delette button for easy access when trying to delete
                currentNote.children("button").data("_id", data.notes[i]._id);
                //  Addding our currentNote to the notesToRender array
                notesToRender.push(currentNote);
            }
        }
    ...
    function handleArticleDelete(){
        //  This funcction handles deleting articles.headlines
    ...
    function handleArticleNotes(){
        //  This function handles opening the notes modal and displaying our otes
        ...
        $.get("/api/notes" + currentArticle._id).then(function(data){
            ...
            //  Ading the formatted HTML to the note modal
            bootbox.dialog({
                message:  modalText,
                closeButton:  true
            })
            ...
            //  Ading some information about the article an article notes to the save button for easy access
